...
---
1. its not working too well, mostly i think because column 7 takes a reaaaalllllly long time to work through. i don't know why though! and it makes everything take a long time to test. BUT the second for-loop works for all i in num. Just need to test first for loop.
```{r}
